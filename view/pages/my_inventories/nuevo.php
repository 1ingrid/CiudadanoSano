<form>
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    <select class="form-control" id="product_id" name="product_id" value="">
        ...
        <div class="col-lg-6">
            <div class="form-group">
                <label class="control-label" for="entries">
                    <strong class="text-danger">*</strong>Entradas
                </label>
                <div class="input-group">
                    <input type="text" class="form-control" id="entries" name="entries" placeholder="Entradas del inventario" value="">
                </div>
            </div>
        </div>
    </div>
