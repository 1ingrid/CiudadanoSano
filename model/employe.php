<?php
    ...
    class Employe extends ModeloAbstractoDB {
        ...
        public function listar() {
			$this->query = 'SELECT employees.id, headquarters.name as seat, seat_id, no_document, employees.name, last_name, email, employees.address, 
            cell_phone, employees.status, employees.created_at, employees.updated_at 
            FROM employees INNER JOIN headquarters ON headquarters.id = employees.seat_id';
